...
public class Company extends TableImpl<CompanyRecord> {
    ...
    /**
     * The column <code>public.company.tin</code>.
     */
    public final TableField<CompanyRecord, Integer> TIN = createField(DSL.name("tin"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.company.checking_account</code>.
     */
    public final TableField<CompanyRecord, Integer> CHECKING_ACCOUNT = createField(DSL.name("checking_account"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<UniqueKey<CompanyRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.COMPANY_TIN_KEY);
    }
